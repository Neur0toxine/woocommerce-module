    ...
    class WC_Integration_Retailcrm {
        ...
        public function __construct() {
            ...
            if (class_exists( 'WC_Integration' ) ) {
                ...
                require_once(dirname(__FILE__ ) . '/include/customer/class-wc-retailcrm-customers-repository-result.php');
                require_once(dirname(__FILE__ ) . '/include/customer/class-wc-retailcrm-customers-repository.php');
